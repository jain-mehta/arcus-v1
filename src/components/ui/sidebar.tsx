    ...
    return (
      <div
        ...
        className={cn(
            ...
            "fixed inset-y-0 z-20 h-full transition-all duration-300 ease-in-out",
            "w-[var(--sidebar-width)] pt-16",
            "group-data-[sidebar-collapsed=true]:w-[var(--sidebar-width-icon)]",
  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-ring transition-[width,height,padding] hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 active:bg-accent active:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-primary data-[active=true]:font-semibold data-[active=true]:text-primary-foreground data-[state=open]:hover:bg-accent data-[state=open]:hover:text-accent-foreground group-data-[sidebar-collapsed=true]:!size-8 group-data-[sidebar-collapsed=true]:!p-2 group-data-[sidebar-collapsed=true]:justify-center [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
        lg: "h-12 text-sm group-data-[sidebar-collapsed=true]:!p-0",
      },
    },
    defaultVariants: {
      variant: "default",
